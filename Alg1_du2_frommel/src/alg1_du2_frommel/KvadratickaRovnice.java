...
public class KvadratickaRovnice {
    ...
    public static void VypocetKVR()
    {
        ...
        if(D<0)
        {
            System.out.println("Diskriminant je menší, než nula -> Rovnice není řešitelná v oboru R");
        }
        else if(D==0)
        {
            reseni[0] = a/b;
        ...
        else
        {
            ...
            System.out.println("Diskriminant je kladný -> Rovnice má dvě POTENCIONÁLNÍ řešení");
